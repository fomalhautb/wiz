...
use std::{os::raw::{c_int, c_void}, ffi::c_float};
...
pub const GGML_OP_RMS_NORM: ggml_op = 19;

pub const GGML_OP_MUL_MAT: ggml_op = 20;

pub const GGML_OP_SCALE: ggml_op = 21;
pub const GGML_OP_CPY: ggml_op = 22;
pub const GGML_OP_CONT: ggml_op = 23;
pub const GGML_OP_RESHAPE: ggml_op = 24;
pub const GGML_OP_VIEW: ggml_op = 25;
pub const GGML_OP_PERMUTE: ggml_op = 26;
pub const GGML_OP_TRANSPOSE: ggml_op = 27;
pub const GGML_OP_GET_ROWS: ggml_op = 28;
pub const GGML_OP_DIAG_MASK_INF: ggml_op = 29;
pub const GGML_OP_SOFT_MAX: ggml_op = 30;
pub const GGML_OP_ROPE: ggml_op = 31;
pub const GGML_OP_ALIBI: ggml_op = 32;
pub const GGML_OP_CLAMP: ggml_op = 33;
pub const GGML_OP_CONV_1D_1S: ggml_op = 34;
pub const GGML_OP_CONV_1D_2S: ggml_op = 35;

pub const GGML_OP_FLASH_ATTN: ggml_op = 36;
pub const GGML_OP_FLASH_FF: ggml_op = 37;

pub const GGML_OP_MAP_UNARY: ggml_op = 38;
pub const GGML_OP_MAP_BINARY: ggml_op = 39;

pub const GGML_OP_COUNT: ggml_op = 40;
